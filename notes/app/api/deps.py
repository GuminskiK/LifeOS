...
current_active_user = Annotated[
    CurrentUserContext, Depends(auth_deps.get_current_active_user)
]
current_admin_user = Annotated[
    CurrentUserContext, Depends(auth_deps.get_current_admin_user)
]
owner_or_admin = Annotated[
    CurrentUserContext, Depends(auth_deps.get_current_owner_or_admin_user)
]
